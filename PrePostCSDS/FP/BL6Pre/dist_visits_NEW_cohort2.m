function dist_visits_NEW(dist_center_filtered,F_sync_cb,mouse,strain)
...
%% Low pass filter z-scored signal
% z_score_prefilt = z_score_cb;
% forder = 4;
% fs = 100;
% fc = 1;
% [b,a] = butter(forder,fc/(fs/2),'low');
% z_score_cb = filtfilt(b,a,double(z_score_prefilt)); 
%fc = cutoff frequency
%fs = sampling frequency (after any downsampling)

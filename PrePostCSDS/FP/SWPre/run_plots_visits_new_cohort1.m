...
for i = 2:total % no tracking data from m3751
    F_data = 'data_foranalysis_m3800_SW.mat';
    dist_data = 'm3800_distcent_data.mat';
    ...
    dist_visits_NEW_cohort1(dist_center_filtered,F_sync,mouse,strain(1:2));
end
